...
public:
    ...
    void setupUi(QWidget *User)
    {
        ...
        User->resize(1300, 600);
        User->setMinimumSize(QSize(1300, 0));
...
"font: 18pt \"\346\245\267\344\275\223\";"));
        ...
        lineEdit->setStyleSheet(QString::fromUtf8("QLineEdit { border-style: none;border: 1px solid #DCDFE6;border-radius: 6px;padding: 5px 10px;font-size: 22px; }\n"
""));
...
"}"));
        ...
        returnButton->setMinimumSize(QSize(120, 50));
        returnButton->setMaximumSize(QSize(16777215, 50));
        QFont font4;
        ...
        returnButton->setStyleSheet(QString::fromUtf8("/**\346\255\243\345\270\270\346\203\205\345\206\265\344\270\213\346\240\267\345\274\217**/\n"
"QPushButton{\n"
"	font: 9pt \"\345\276\256\350\275\257\351\233\205\351\273\221\";\n"
"    color: #2f3640;\n"
"    background-color: #f5f6fa;\n"
...
"QLineEdit:hover{ border: 1px solid #409EFF; }"));
        ...
        label_5->setPixmap(QPixmap(QString::fromUtf8(":/icon/unLabel.PNG")));
...
"QLineEdit:hover{ border: 1px solid #ff577a; }"));
        ...
        label_6->setPixmap(QPixmap(QString::fromUtf8(":/icon/emailLabel.PNG")));
...
"QLineEdit:hover{ border: 1px solid #ff577a; }"));
        ...
        label_7->setPixmap(QPixmap(QString::fromUtf8(":/icon/adminLabel.PNG")));
        ...
        lineEdit_4->setStyleSheet(QString::fromUtf8("QTableView,QLineEdit{ background-color: #fcf5ea; border: 1px solid #DCDFE6; border-radius: 6px; padding: 5px 10px; font-size: 20px; }\n"
"QLineEdit:hover{ border: 1px solid #ff577a; }"));
...
"}"));
        ...
        label->setMinimumSize(QSize(190, 190));
        label->setMaximumSize(QSize(250, 250));
        label->setStyleSheet(QString::fromUtf8(" border-radius: 6px"));
        label->setPixmap(QPixmap(QString::fromUtf8(":/icon/schoolLogo.png")));
        ...
        label_3->setPixmap(QPixmap(QString::fromUtf8(":/icon/borrowLabel.PNG")));
        ...
        pushButton_4->setMinimumSize(QSize(50, 40));
...
"}"));
        ...
        pushButton_3->setMinimumSize(QSize(50, 40));
...
"}"));
        ...
        pushButton_8->setMinimumSize(QSize(50, 40));
...
"font: 14pt \"\345\256\213\344\275\223\";"));
    ...
    void retranslateUi(QWidget *User)
    {
        ...
        returnButton->setText(QCoreApplication::translate("User", "\350\277\224\345\233\236\344\270\273\351\241\265\351\235\242", nullptr));
        pushButton_2->setText(QCoreApplication::translate("User", "\345\200\237\351\230\205\345\233\276\344\271\246", nullptr));
        label_5->setText(QString());
        label_6->setText(QString());
        label_7->setText(QString());
        pushButton_5->setText(QCoreApplication::translate("User", "\351\200\200\345\207\272\347\231\273\345\275\225", nullptr));
        label->setText(QString());
        label_3->setText(QString());
        pushButton_4->setText(QCoreApplication::translate("User", "\345\206\215\346\254\241\345\200\237\344\271\246", nullptr));
