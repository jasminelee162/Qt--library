...
"QToolButton:hover { color: #1E90FF; font-weight: bold; background-color: #fd839a; }"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icon/gl.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"QLineEdit:hover{ border: 1px solid #409EFF; }"));
        ...
        pushButton->setStyleSheet(QString::fromUtf8("font: 75 11pt \"Agency FB\";\n"
""));
...
""));
        ...
        tableView->setStyleSheet(QString::fromUtf8("font: 11pt \"\345\256\213\344\275\223\";"));
